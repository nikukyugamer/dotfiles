...
# go_install github.com/itchyny/fillin@latest # fill-in your command and execute
...
go_install github.com/simonwhitaker/gibo@latest # gibo: fast access to .gitignore boilerplates https://github.com/simonwhitaker/gibo
